...
\begin{wrapfigure}[31]{r}{.45\textwidth}
	\centering
	\includegraphics[width=.45\textwidth]{aux/figures/parsing-diagram}
...
\begin{wrapfigure}{r}{.45\textwidth}
	\centering
	\begin{tikzpicture}
		\node (fig) at (0, 0) {\includegraphics[width=.4\textwidth]{aux/figures/knitting-example}};
...
\begin{wrapfigure}[21]{l}{.5\textwidth}
	\centering
