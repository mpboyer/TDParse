...
\rotatebox{90}{%
	\begin{tikzpicture}
		...
		%
		\node[rectangle, draw=black] (cn) at ($(ncat-u) + (.5, 0)$) {$\rotatebox{-90}{\f{M}\e}$};
		...
		+ (0, 3) coordinate (tfm)
		+ (6, 9) coordinate[label=right:$\rotatebox{-90}{\f{M}}$] (functorm)
		...
		+ (0, 3) coordinate (tfd)
		+ (4, 7) coordinate[label=right:$\rotatebox{-90}{\f{D}}$] (functord)
		++ (2, 0) node[rectangle, draw=black] (app) {$\rotatebox{-90}{>}$}
		+ (0, 3) coordinate (tft)
		+ (2, 5) coordinate[label=right:$\rotatebox{-90}{\t}$] (end);
		%
		\begin{scope}
		...
		(fmap2) -- (tfd)
		(app) -- (tft);
		\draw (tfm) to[out=90, in=180] (functorm)
		(tfd) to[out=90, in=180] (functord)
		(tft) to[out=90, in=180] (end);
		%
