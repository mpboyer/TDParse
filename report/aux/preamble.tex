...
\newcommand{\suppfrac}[2]{%
	{\sbox0{$\genfrac{}{}{0pt}{0}{\raisebox{\fracpad}{\ensuremath{#1}}}{\raisebox{-\fracpad}{\ensuremath{#2}}}$}%
			\vphantom{\copy0}%
			\ooalign{%
				\hidewidth
				$\vcenter{\moveright\nulldelimiterspace
...
\newcommand{\prooffrac}[2]{\genfrac{}{}{}{0}{\raisebox{\fracpad}{\ensuremath{#1}}}{\raisebox{-\fracpad}{\ensuremath{#2}}}}%
