...
\begin{figure}
	\centering
	\begin{tikzpicture}
		\node (fig) at (0, 0) {\includegraphics[width=.8\columnwidth]{aux/figures/knitting-example}};
...
usual parsing trees, answering such complex questions might seem a stretch.
