...
\begin{frame}
	...
	\begin{itemize}
		...
		\item An typed lexicon (possibly with effects).
...
\begin{frame}[allowframebreaks]
	...
	\begin{thm}[Normalization Complexity]
		\label{thm:normalize}
		Normalizing a diagram is done in quadratic time in
...
\begin{frame}
	...
	\rotatebox{-90}{\includegraphics[height=\textwidth]{aux/figures/parsing-diagram2.pdf}}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Theoretical enhancement of a type system for natural language semantics;
		      \pause
		\item No more load on the user (comprehension) nor the parser (efficiency).
	\end{itemize}
