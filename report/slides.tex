...
\begin{frame}[allowframebreaks, fragile]
	...
	\begin{tikzpicture}[scale=.75]
		\tikzset{every tree node/.style={align=center, anchor=north}, level distance=2cm}
		\Tree [
...
\begin{frame}
	...
	By writing our combinators as natural transformations, we can apply the idea
	of string diagrams to parsing, and make use of the speed of the equality
	algorithms:
	\resizebox{\textwidth}{!}{%
	...
	The use of string diagrams allows us to prove a set of reductions/equalities
	between rules in our grammar, and reduce the complexity of our parsing
	algorithm, by a confluent rewriting system just as before.
\end{frame}
...
\begin{frame}
	...
	\vspace{-1.5cm}
	\begin{center}
		\raisebox{0cm}{\resizebox{\textwidth}{!}{\rotatebox{-90}{\inputtikz{parsing-diagram}}}}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\raisebox{0cm}{\resizebox{\textwidth}{!}{\rotatebox{-90}{\inputtikz{parsing-diagram2}}}}
	\end{center}
\end{frame}

\begin{frame}
	\frametitle{One less thing}
	\vspace{-1.75cm}
	\centering
	\resizebox{.7\textwidth}{!}{\rotatebox{-90}{\inputtikz{3d-parsing-diagram}}}
\end{frame}
