...
\begin{NiceTabular}{LLc}
	...
	\f{F}\phi\left( \tau \right) = \tau \times \f{S}\tau                     & \f{F}\left( \scalar{v, \left\{ x \suchthat x \in D_{e} \right\}} \right) = \scalar{\phi\left(v\right), \left\{ x \suchthat x \in D_{e} \right\}}                  & Monad     \\
