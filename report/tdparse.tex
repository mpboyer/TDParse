...
\subsection{Naïvely Computing Parsing Trees}
The naïve algorithm for parsing is built of two phases: first we compute a set of valid denotations for the sentence according to the grammar and type system; then we handle the effects generated by the computation.
...
\subsubsection{In Tree Generation}

\subsubsection{In Effect Handling}
Section \ref{sec:nondet} explains how to solve non-determinism in effect handling using string diagrams.
