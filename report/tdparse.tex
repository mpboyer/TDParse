...
\cite{bumfordEffectdrivenInterpretationFunctors2025} provide a formal analysis of islands\footnote{Syntactic
...
\begin{equation*}
	\mathrm{PT}\left(
		\dashdfrac{\cont x_{1}: \f{F}\f{C}\f{F'}\tau}{\cont x_{1}: \f{F}\f{F'}\tau}\suchthat
		\dashdfrac{\cont x_{2}: \f{F}\f{C}\f{F'}\tau}{\cont x_{2}: \f{F}\f{F'}\tau}
	\right)
\end{equation*}
