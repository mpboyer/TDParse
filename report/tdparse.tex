...
\newtcbox{\tboxed}{on line, colframe=black, boxsep=1pt, left=2pt, right=2pt, top=1pt, bottom=1pt, arc=2pt, boxrule=1pt}
\foreach\i in {0,...,10}{%
	\pgfmathtruncatemacro{\j}{\i * 10}
	\expandafter\colorlet{boxcolor}{vulm!\j!yulm}
	\i, \j, \textcolor{boxcolor}{Hello,} \\
	\newtcbox{thefbox\i}{on line, colback=boxcolor, boxsep=1pt, left=2pt, right=2pt, top=1pt, bottom=1pt, arc=2pt}
}

\def\functor#1#2{\csname thefbox#1\endcsname{\tt #2}}
\def\effect#1#2#3{%
	\tboxed{\functor{#1}{#2}~\ensuremath{\tt #3}}
}
